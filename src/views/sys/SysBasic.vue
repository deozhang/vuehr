<template>
    <div>
        <el-tabs v-model="activeName" type="card">
            <el-tab-pane label="课程类型" name="depmana"><DepMana></DepMana></el-tab-pane>
            <el-tab-pane label="教师管理" name="posmana"><PosMana></PosMana></el-tab-pane>
            <el-tab-pane label="课程管理" name="joblevelmana"><JobLevelMana></JobLevelMana></el-tab-pane>
